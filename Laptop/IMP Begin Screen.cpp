	...
	default:
		...
		if( layout == 0x419 ) // Russian
		{
			unsigned char TranslationTable[] = 
				" #щ####Щ####А-Ч.0123456789фФа#ч,#тхябсюопьнкдэрыгийшецлжвмъУ#З#_╦ТХЯБСЮОПЬНКДЭРЫГИЙШЕЦЛЖВМЪу#з╗";
		...
		{
			unsigned char TranslationTable[] = 
				" #щ####Щ####А-Ч.0123456789фФа#ч,#т╡ябсюопьнкдэр║гийшецлжвмъУ#'#_╦ТЁЯБСЮОПЬНКДЭР╒ГИЙШЕЦЛЖВМЪу#'╗";
