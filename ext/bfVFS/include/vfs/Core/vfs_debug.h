...
namespace vfs
{
	...
	{
	public:
		Exception(String const& text, String const& function, int line, const char* file);
		Exception(String const& text, String const& function, int line, const char* file, std::exception& ex);

		virtual ~Exception() throw();

		virtual const char* what() const throw();

		String      getLastEntryString() const;
		String      getExceptionString() const;
