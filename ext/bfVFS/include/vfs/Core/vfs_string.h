...
namespace vfs
{
	...
	{
		friend VFS_API bool operator<(String const& s1, String const& s2);
	public:
		...
		////////////////////////////////////////////////////////////////////
		static bool less        (const String::char_t* s1, const String::char_t* s2);
		static bool equal       (const String::char_t* s1, const String::char_t* s2);
		// case sensitive
		static bool lessCase    (const String::char_t* s1, const String::char_t* s2);
		static bool equalCase   (const String::char_t* s1, const String::char_t* s2);

		template<bool (*funName)(const String::char_t* s1, const String::char_t* s2)>
		class Op{
		public:
		...
		typedef Op<String::less>        Less;
		typedef Op<String::lessCase>    LessCase;
		typedef Op<String::equal>       Equal;
		typedef Op<String::equalCase>   EqualCase;
	...
	public:
		...
		////////////////////////////////////////////////////////////////////
		static String::str_t        as_utfW(const char*         str);
		static void                 as_utfW(const char*         str, String::str_t &strW);
		static String::str_t        as_utfW(std::string  const& str);
		static void                 as_utfW(std::string  const& str, String::str_t &strW);

		// fast conversion without creating an internal copy
		static std::string          as_utf8(String       const& str);
		static std::string          as_utf8(std::wstring const& str);
		// if 'strlen' is 0, length is determined automatically
		static std::string          as_utf8(const wchar_t*      str, String::size_t strlength=0);
		//
		static std::string          narrow (wchar_t const*      str, String::size_t length);
		static String::size_t       narrow (wchar_t const*      src, String::size_t src_len, char*    dst, String::size_t dst_len);
		static String::size_t       narrow (std::wstring const& src, std::string& dst);
		//
		static std::wstring         widen  (char const*         src, String::size_t length);
		static String::size_t       widen  (char const*         src, String::size_t src_len, wchar_t* dst, String::size_t dst_len);
		static String::size_t       widen  (std::string  const& src, std::wstring&  dst);
		...
		////////////////////////////////////////////////////////////////////
		bool                        empty() const;
		String::size_t              length() const;

		////////////////////////////////////////////////////////////////////
		String operator+ (vfs::String const& str);
		String operator+=(vfs::String const& str);
...
namespace vfs
{
	VFS_API bool        operator<(String const& s1, String const& s2);
}
