...
namespace vfs
{
	...
	{
	protected:
		FileLogger(Path const& log_file, bool append = false, Log::EFlushMode flush_mode = Log::FLUSH_ON_ENDL);
		FileLogger(WritableFile_t* file, bool append = false, Log::EFlushMode flush_mode = Log::FLUSH_ON_ENDL);

	public:
		VFS_SMARTPOINTER(FileLogger);
