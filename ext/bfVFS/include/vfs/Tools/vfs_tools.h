...
namespace vfs
{
	...
	bool convertTo(String const& sStr, T_ &rVal)
	{
	...
	template<typename T_>
	String toStringList(std::list<T_> const& rValList)
	{
		std::wstringstream ss;
	...
	template<>
	VFS_API String toStringList<String>(std::list<String> const& rValList);
