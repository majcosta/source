...
if(BFVFS_WITH_PAK)
  set(INCLUDE_Ext_pak
    ${MOD_INCLUDE}/pak/vfs_pak_header.h
    ${MOD_INCLUDE}/pak/vfs_pak_library.h
	${MOD_INCLUDE}/pak/vfs_create_pak_library.h
  )
  set(SOURCE_Ext_pak
    ${MOD_SOURCE}/pak/vfs_pak_library.cpp
	${MOD_SOURCE}/pak/vfs_create_pak_library.cpp
  )
  source_group("Ext" FILES ${INCLUDE_Ext_pak} ${SOURCE_Ext_pak})
endif()
...
set(${mod}_files
  ...
  ${INCLUDE_Ext_pak}  ${SOURCE_Ext_pak}
  CACHE INTERNAL ""
)
